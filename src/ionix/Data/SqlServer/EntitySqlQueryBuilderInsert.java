...
public class EntitySqlQueryBuilderInsert extends ionix.Data.EntitySqlQueryBuilderInsert {
    ...
    public EntitySqlQueryBuilderResult createQuery(Object entity, EntityMetaData metaData) {
        ...
        for(FieldMetaData field : metaData.getFields()){
            ...
            switch(schema.getDatabaseGeneratedOption()){
                ...
                case AutoGenerateSequence:
                    throw new UnsupportedOperationException("InsertQueryBuilder does not support AutoGenerateSequence");
                default:
        ...
        return new EntitySqlQueryBuilderResult(query, identity != null ? AutoGeneratedKey.RETURN_GENERATED_KEYS : AutoGeneratedKey.NO_GENERATED_KEYS
        , identity, query.getParameters().size());
    }
}
